...
import ScalesoftIsotype from '../public/res/logos/scalesoft-isotipo.svg';
    ...
    <>
      <div className='bg-primary-900'>
        <div className='max-w-6xl m-auto text-gray-800 flex flex-wrap justify-center'>
          <div className='flex duration-200 cursor-pointer my-auto md:mr-16 items-baseline w-48'>
            <ScalesoftIsotype />
            <h1 className='font-quick text-4xl ml-2 text-white '>
          ...
          <div className='p-5 w-48 '>
            ...
            <a className='my-3 block font-open text-neutral-300' href='/#'>
              Nuestros productos{' '}
              <span className='text-teal-300 text-xs p-1'></span>
            </a>
            <a className='my-3 block font-open text-neutral-300' href='/#'>
              Proyectos <span className='text-teal-300 text-xs p-1'>Nuevo</span>
            </a>
            <a className='my-3 block font-open text-neutral-300' href='/#'>
          ...
          <div className='p-5 w-48 '>
            ...
            <a className='my-3 block font-open text-neutral-300' href='/#'>
              Conditions <span className='text-teal-300 text-xs p-1'></span>
            </a>
          </div>
          <div className='p-5 w-48 '>
            <div className='text-xs font-poppins text-white uppercase font-medium'>
      ...
      <div className='bg-primary-900 pt-2'>
        <div
          className='flex pb-5 px-3 m-auto pt-5 border-t border-neutralv-500 text-gray-500 text-sm flex-col
      md:flex-row max-w-6xl'
        >
          <div className='mt-2'>
            © Copyright 2020. Todos los derechos reservados.
          </div>
          <div className='flex-auto flex-row-reverse mt-2 flex-row flex'>
