...
export default function Header() {
  ...
  return (
    <header className="text-white sm:flex">
      <div className='flex items-center justify-between px-4 lg:pl-8 py-4'>
        <div>
          <h1 className='font-quick text-2xl md:text-4xl'>
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} px-2 pt-2 pb-4 sm:p-0 sm:ml-auto sm:pr-1 lg:pr-6 font-open sm:flex sm:items-center`}>
        <a
          href='#'
